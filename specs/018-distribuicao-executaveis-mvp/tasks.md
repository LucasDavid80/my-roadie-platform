...
- [x] T1.2 — Adicionar fallback seguro de produção (`https://my-roadie-backend.onrender.com`) na injeção de `--dart-define=BACKEND_URL` em `mobile-android-build` e `mobile-ios-build` no CI/CD.
