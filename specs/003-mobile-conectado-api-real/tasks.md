...
- [ ] T2.1 — Implementar `agenda_repository_impl.dart` usando o datasource da Fase 1.
- [ ] T2.2 — Confirmar `user_repository_impl.dart` (já presente) está alinhado ao datasource.

## Fase 3 — Conectar telas

- [ ] T3.1 — Conectar tela de agenda (`principal_screen.dart`) ao repository real, removendo mock.
