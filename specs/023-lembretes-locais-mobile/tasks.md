...
- [ ] T0.2: Adicionar dependências `flutter_local_notifications` e `timezone` ao `pubspec.yaml` e rodar `flutter pub get`
...
- [ ] T3.1: Criar `mobile/test/services/notification_service_test.dart` cobrindo os 6 casos definidos no `plan.md` (T-U1 a T-U6): agendamento com startTime futuro > 24h, entre 2h e 24h, passado, nulo, cancelamento individual e cancelamento total
