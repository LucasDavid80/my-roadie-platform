...
describe('TestersPage Component e isValidDownloadUrl (Spec 018 / Task T4.1)', () => {
    ...
    describe('Cenário 1: Variáveis de ambiente ausentes (Fallback / Indisponível sem 404)', () => {
        ...
        it('deve renderizar o título principal, badges de "Em breve" e botões desabilitados', () => {
            render(<TestersPage />);
        ...
        it('deve exibir mensagens de alerta explicando que o download não está configurado neste ambiente', () => {
            render(<TestersPage />);
        ...
        it('deve renderizar versão padrão "MVP 1.0.0" no header e rodapés dos cards', () => {
            render(<TestersPage />);
        ...
        it('deve renderizar link alternativo padrão para GitHub Releases', () => {
            render(<TestersPage />);
    ...
    describe('Cenário 2: Variáveis de ambiente configuradas com URLs válidas (Download Ativo)', () => {
        ...
        it('deve exibir badges de status ativo ("Instalação Direta" e "Sideload Gratuito")', () => {
            render(<TestersPage />);
        ...
        it('deve renderizar links de download ativos com atributos href e download corretos', () => {
            render(<TestersPage />);
        ...
        it('deve renderizar a versão dinâmica customizada no header e nos cards', () => {
            render(<TestersPage />);
        ...
        it('deve apontar o link de releases para a URL customizada configurada', () => {
            render(<TestersPage />);
    ...
    describe('Cenário 3: Cenário híbrido (Apenas APK configurado, IPA indisponível)', () => {
        ...
        it('deve renderizar link ativo para Android e botão desabilitado para iOS', () => {
            render(<TestersPage />);
    ...
    describe('Cenário 4: Instruções de instalação e notas informativas', () => {
        it('deve renderizar as instruções passo a passo para Android e iOS', () => {
            render(<TestersPage />);
